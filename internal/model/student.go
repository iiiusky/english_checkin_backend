...
type Student struct {
	...
	AvatarURL   string `gorm:"column:avatarUrl;type:varchar(1023);comment:URL of the user's avatar." json:"avatar_url"`
	PhoneNumber string `gorm:"column:phoneNumber;type:varchar(50);comment:User's phone number." json:"phone_number"`
